...
<div id="interface">
    ...
    <aside id="menu-lateral">
        ...
        <section id="botoes">
            <li><a href="cadsafras.php">Nova Safra</a></li>   
    ...
    <aside id="right"> 
        <?php
            ...
            $query = mysql_query("select saf_codigo, saf_nome from safra")
        ?>
        <form id="formuser" action="_php/cadcolheita.php" method="POST">
            <header id="headerusers">
                <p><b>Cadastro de Colheita</b></p>
            </header>
            <section id="body">
                <p>Código:<input type="number" id="cCod" name="tCod" size="6"min="0" max="99999"></p>
                <p><label for="tSafra">Safra:</label>
                    <select name="cSafra" id="tSafra">                        
                        <?php while ($safra = mysql_fetch_array($query)) { ?>
                        <option value="<?php echo $safra['saf_codigo']?>"><?php echo $safra['saf_nome']?></option><?php } ?>
                    </select>
                </p>                                                                     
                <p>Data do Fim: <input type="date" id="cDf" name="tDf" size="20"></p>
                <p>Produção Final(Kg): <input type="number" name="cPf" id="tPf" size="20"></p>
